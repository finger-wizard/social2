...
<div class="bg-white drop-shadow-md rounded px-4 py-6">
    <span class="text-base font-semibold ml-1">Recommended for You</span>
    <div class="flex flex-col gap-2 mt-3">
        ...
        if (!($all_recomended_user->num_rows < 1)) {
            ...
            <div class="pb-2 pt-8 text-sm text-center">Hmm. It looks like you are following everyone.</div>
        <?php } ?>
    </div>
</div>
