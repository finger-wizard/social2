<form method="POST" enctype="multipart/form-data">
    <div class="mb-4 mt-10 flex flex-col items-start gap-2 w-full">
        ...
        <textarea id="post-comment-title" name="post_comment_title" class="w-full bg-transparent border border-gray-300 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 resize-none placeholder-gray-500 text-gray-600" placeholder="Write something about this post..." rows="3"></textarea>
