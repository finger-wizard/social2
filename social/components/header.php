        ...
        <div class="container justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div class="h-full flex items-center">
                <div aria-label="Home" role="img" class="mr-10 flex items-center">
                    <a href="/social2/social/pages/index.php">
                        <h3 class="text-base text-gray-800 font-bold tracking-normal leading-tight ml-0 md:ml-3 lg:block">MingLR</h3>
                    </a>
                </div>
            </div>
            <div class="pr-12 h-full flex items-center">
                <div class="relative w-full">
                    ...
                    <input class="border border-gray-100 focus:outline-none focus:border-indigo-700 w-full md:w-80 rounded text-sm text-gray-500 placeholder-gray-600 bg-gray-100 pl-8 py-2" type="text" placeholder="Search in MingLR Dictionary..." />
                </div>
            </div>
                ...
                <div class="w-full h-full flex items-center">
                    ...
                    <?php } else { ?>
                        <div class="flex items-center gap-2">
                            <a href="sign-in.php">
                                <button role="button" class="h-10 min-w-fit bg-gray-200 focus:outline-none transition duration-150 ease-in-out hover:bg-gray-300 rounded text-indigo-600 px-6 py-2 mr-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 text-sm">Let's get In</button>
                            </a>
                            <a href="sign-up.php">
                                <button role="button" class="h-10 min-w-fit focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-2 text-sm">Let's get Started</button>
                            </a>
                        </div>
                    <?php } ?>
                </div>
